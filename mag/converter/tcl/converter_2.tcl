...
#set LS2 [expr {(($n_cell - 1)*$size + 2*($guard_offset_x + $guard_width) - 5)*2 + 2*(($p_cell - 1)*$size + 1*($guard_offset_x + $guard_width) - 5)}]
set LS4 [expr {(($guard_offset_x + $guard_width) - 5) - 16}]
set LS3 [expr {2*(($n_cell - 1)*$size + ($guard_offset_x + $guard_width) - 5) + $LS4 + 16}]
set LS2 [expr {$LS3 + 2*(($guard_offset_x + $guard_width) - 5) - 16}]
set LS1 [expr {$LS2 + 2*($p_cell - 1)*$size + 2*($guard_offset_x + $guard_width) + 16}]
...
proc add_obsactive_layer_to_converter {} {
    ...
    select cell power_stage_2_0/nmos_waffle_14x14_1
    set obsactive_margin [expr [lindex [box size] 0] / 3.0]

    add_obsactive_box_margin power_stage_2_0/nmos_waffle_14x14_0 ${obsactive_margin}i
    add_obsactive_box_margin power_stage_2_0/nmos_waffle_14x14_1 ${obsactive_margin}i
    add_obsactive_box_margin power_stage_2_0/pmos_waffle_26x26_0 ${obsactive_margin}i
    add_obsactive_box_margin power_stage_2_0/pmos_waffle_26x26_1 ${obsactive_margin}i

    remove_obsactive_from_device power_stage_2_0/nmos_waffle_14x14_0
    remove_obsactive_from_device power_stage_2_0/nmos_waffle_14x14_1
    remove_obsactive_from_device power_stage_2_0/pmos_waffle_26x26_0
    remove_obsactive_from_device power_stage_2_0/pmos_waffle_26x26_1
...
select area obsactive
delete
box [expr {$LS1 + 20.47}]um [expr {$ypos - 34}]um [expr {$LS1 + 23.47}]um [expr {$ypos + 0.5}]um
...
select area obsactive
delete
box [expr {$LS2 + 20.47}]um [expr {$ypos - 34}]um [expr {$LS2 + 23.47}]um [expr {$ypos + 0.5}]um
paint {metal2 metal3 metal4 metal5}
...
select area obsactive
delete
box [expr {$LS3 + 20.47}]um [expr {$ypos - 34}]um [expr {$LS3 + 23.47}]um [expr {$ypos + 0.5}]um
paint {metal2 metal3 metal4 metal5}
...
select area obsactive
delete
box [expr {$LS4 + 20.47}]um [expr {$ypos - 34}]um [expr {$LS4 + 23.47}]um [expr {$ypos + 0.5}]um
paint {metal2 metal3 metal4 metal5}
