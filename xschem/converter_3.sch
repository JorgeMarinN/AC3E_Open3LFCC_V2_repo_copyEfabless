...
C {driver_bootstrap.sym} 260 -120 0 0 {name=x1}
...
C {power_stage_3.sym} 820 -160 0 0 {name=x2}
...
C {level_shifter.sym} 240 60 0 0 {name=x3}
...
C {devices/lab_pin.sym} 400 -120 2 0 {name=p1 sig_type=std_logic lab=S1}
